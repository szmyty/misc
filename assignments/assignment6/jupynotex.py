...
"""USAGE: jupynotex.py notebook.ipynb cells.
...
# highlighters for different languages (block beginning and ending)
HIGHLIGHTERS = {
...
FORMAT_OK = (
    r"coltitle=black!75!black, colbacktitle=black!10!white, "
        ...
        for item in outputs:
            ...
            if output_type == "execute_result":
                ...
                if "text/latex" in data:
                    ...
                    if isinstance(latex_data, str):
                        result.append(latex_data)
                    else:
                        result.extend(latex_data)
...
def _parse_cells(spec, maxlen):
    ...
    if maxlen < cells[-1]:
        raise ValueError(
            "Notebook loaded of len {}, smaller than requested cells: {}".format(
                maxlen, cells
            )
        )
