...
# Log low levels to stdout.
stdout_handler: StreamHandler = StreamHandler(stream=sys.stdout)
stdout_handler.addFilter(lambda rec: rec.levelno <= INFO)
logger.addHandler(stdout_handler)

# Log low levels to stderr.
stderr_handler: StreamHandler = StreamHandler(stream=sys.stderr)
stderr_handler.addFilter(lambda rec: rec.levelno > INFO)
