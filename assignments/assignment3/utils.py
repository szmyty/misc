...
def get_truth_statistics_df(
    ...
    """Get the actual truth statistics dataframe table from metrics.

    Args:
        accuracy (float): The accuracy metric.
        true_positives (int): The true positives metric.
        false_positives (int): The false positives metric.
        true_negatives (int): The true negatives metric.
        false_negatives (int): The false negatives metric.

    Returns:
        DataFrame: The truth statistics dataframe table.
    """
...
def get_truth_statistics(
    ...
    return get_truth_statistics_df(
        accuracy=accuracy,
...
def save_df_as_figure(df: DataFrame, filename: str) -> None:
    """Save a dataframe table as a figure using matplotlib.

    Args:
        df (DataFrame): The dataframe to save as a svg.
    ...
    save_figures(filename, artifacts)
