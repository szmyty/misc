...
def long_to_wide(
    df: pd.DataFrame,
    groupvars: Union[str, List[str]],
    values: Union[str, List[str]],
    colindex: Optional[Union[str, List[str]]] = None,
    colindex_only: bool = False,
):
    """
...
def winsorize(
    df: pd.DataFrame,
    pct: Union[float, Tuple[float, float]],
