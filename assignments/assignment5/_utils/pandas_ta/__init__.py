...
_TA = _add_functions(
    "pandas_ta.technical_analysis",
    filter=lambda _, x: x[3:] if x.startswith("ta_") else None,
)
monkey_patch_dataframe = _partial(
    _monkey_patch_dataframe, extension_default_value="ta", extension_class=_TA
)
