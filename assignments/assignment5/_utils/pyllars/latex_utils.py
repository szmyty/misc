...
def write_simple_row(
    out,
    content: list,
    initial_ampersand: bool = False,
    final_new_row: bool = True,
    height: str = None,
):
...
def write_graphics(
    ...
    height: str = None,
    width: str = None,
    write_textwidth: bool = True,
    write_textheight: bool = True,
