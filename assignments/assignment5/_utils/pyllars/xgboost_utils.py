...
def xgbooster_predict_proba(booster: xgb.Booster, d_x: xgb.DMatrix) -> np.ndarray:
    ...
    **kwargs : key=value pairs
    ...
    def _validate(self, xgboost_callback_env):
        ...
        validation_roc = sklearn.metrics.roc_auc_score(
            y_true=self._dval.get_label(), y_score=y_score
        )
    ...
    def fit(
        ...
        self.booster_ = xgb.train(
            xgb_kwargs, self._dtrain, self.num_boost_round, callbacks=callbacks
        )
