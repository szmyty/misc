...
BarChartColorOptions = Union[matplotlib.colors.Colormap, Sequence, int, str]
...
def set_legend_title_fontsize(ax: plt.Axes, fontsize: IntOrString) -> None:
...
def set_legend_fontsize(ax: plt.Axes, fontsize: IntOrString) -> None:
...
def set_title_fontsize(ax: plt.Axes, fontsize: IntOrString) -> None:
...
def set_label_fontsize(ax: plt.Axes, fontsize: IntOrString, axis: str = "both") -> None:
...
def set_ticklabels_fontsize(
    ax: plt.Axes, fontsize: IntOrString, axis: str = "both", which: str = "major"
):
...
def set_ticklabel_rotation(
    ax: plt.Axes, rotation: IntOrString, axis: str = "x", which: str = "both"
):
...
def hide_tick_labels(ax: plt.Axes, axis: str = "both") -> None:
...
def hide_tick_labels_by_text(
    ax: plt.Axes, to_remove_x: Collection = set(), to_remove_y: Collection = set()
) -> None:
...
def plot_simple_bar_chart(
    ...
    if xticklabels is not None:
        ...
        ax.set_xticklabels(
            xticklabels, fontsize=tick_fontsize, rotation=xticklabels_rotation
        )
    else:
        ax.tick_params(
...
def plot_confusion_matrix(
    ...
    mappable = ax.imshow(
        confusion_matrix, interpolation="nearest", cmap=cmap, vmin=vmin, vmax=vmax
    )
